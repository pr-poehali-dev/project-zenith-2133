...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Сроки зависят от площади и вида работ. Стандартная квартира под ключ — от 2 до 4 месяцев. Перед стартом мы фиксируем точные сроки в договоре и неукоснительно их соблюдаем. Вы всегда знаете, когда будет готово.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Дизайн-проект помогает избежать ошибок и сэкономить бюджет. Мы предлагаем услугу дизайна интерьера и планировки в комплексе с ремонтом. Если у вас уже есть проект от другого дизайнера — работаем по нему.",
  },
  {
    question: "Как начать сотрудничество?",
    answer:
      "Просто свяжитесь с нами — по телефону, почте или через форму на сайте. Мы проведём бесплатную консультацию, выедем на объект, замеряем площадь и подготовим детальную смету. Всё бесплатно и ни к чему не обязывает.",
  },
]
